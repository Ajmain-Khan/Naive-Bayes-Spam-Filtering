 ...
 */
public class NaiveBayes extends Task<Object> {
    ...
    /**
     * Instantiate new naive bayes spam detection.
     *
     * @param mainDirectory the main directory
     * @param table         the table
     */
    public NaiveBayes(File mainDirectory, TableView<TestFile> table) throws IOException {
    ...
    public void init() throws FileNotFoundException, NullPointerException {
        ...
        trainHamFolder = new File(mainDirectory.getPath() + "/data/train/ham");
        trainHamFolder2 = new File(mainDirectory.getPath() + "/data/train/ham2");
        trainSpamFolder = new File(mainDirectory.getPath() + "/data/train/spam");
        ...
        // Get test files
        testHamFolder = new File(mainDirectory.getPath() + "/data/test/ham");
        testSpamFolder = new File(mainDirectory.getPath() + "/data/test/spam");
    ...
    public void loadStopWords() throws FileNotFoundException {
        Scanner scanner = new Scanner(new File("src/main/stopwords.txt"));
        while (scanner.hasNext()) {
